...
/mnt/genomics/bin/samtools mpileup -f /mnt/genomics/mrosasco/annotation/GRCh38/Homo_sapiens.GRCh38.dna.primary_assembly.fa -B -C 50 -d 250 -l $bedfile -q 30 -Q 13 -g -e 20 -h 100 -L 250 -o 40 $infile -o $bcf_outfile
